pipeline {
    ...
    environment {
		...
		PORT = 8089
		KUBERNETES_DEPLOYMENT = 'https://github.com/henryburgos/desafio/blob/master/desafio3-deployment.json'
		KUBERNETES_SERVICE = 'https://github.com/henryburgos/desafio/blob/master/desafio3-service.json'
